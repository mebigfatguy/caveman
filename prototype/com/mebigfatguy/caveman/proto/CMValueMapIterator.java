...
/**
 * An iterator over a collection of <b>Object/CM</b> elements
 */
public interface CMValueMapIterator<K> {

    /**
     * Returns <tt>true</tt> if the iteration has more <b>Object/CM</b> elements. (In other
    ...
    /**
     * Positions the iterator at the next <b>Object/CM</b> element in the iteration.
     *
	...
	/**
	 * Returns the <b>Object</b> key pointed at by the iterator
	 * 
	...
	/**
	 * Returns the <b>CM</b> value pointed at by the iterator
	 * 
    ...
    /**
     * 
     * Removes from the underlying collection the last <b>Object/CM</b> element returned by the
